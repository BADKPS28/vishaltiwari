const SKILLS = [
  "Microsoft 365", "Azure", "AWS", "Azure IoT", "SharePoint",
  "Office 365", "Microsoft Copilot", "AI & Automation",
  "Digital Transformation", "Enterprise Collaboration",
];
        ...
        <div className="about-header">
          ...
          <div>
            ...
            <div className="about-contact">
              ...
              <a href="https://www.linkedin.com/in/vishal-tiwari-9b164b22/" target="_blank" rel="noopener noreferrer" className="about-contact-item">
